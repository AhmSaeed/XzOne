...
public class RecordsController implements Initializable {
    ...
    private void getAllMatches() {
        ...
        //File file = new File("C:\\Users\\khattab\\Documents\\NetBeansProjects\\"
        //        + "JavaProject\\XzOne\\src\\Records");
    ...
    private void sendData() {
        ...
        int[] moves = null;
        GameMoves gameMovesToBeSent = null;
        moves = gameMoves.getMoves();
        gameMovesToBeSent = GameMovesHolder.getGAME_MOVES();
        gameMovesToBeSent.setMoves(moves);
        gameMovesToBeSent.setTwoPlayers(gameMoves.getPlayerOne(), gameMoves.getPlayerTwo());
    }
